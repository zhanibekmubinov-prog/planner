...
from .routers import auth as auth_router, directions, mcp, mcp_oauth, mindmaps, notify, projects, shares, simple, tasks, tools
...
app = FastAPI(title="CIS Planner API", version="0.6.0", lifespan=lifespan)
