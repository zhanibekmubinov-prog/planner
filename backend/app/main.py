...
from .routers import directions, notify, simple, tasks, tools
...
for r in (directions.router, tasks.router, tools.router, simple.people, simple.delegations, simple.reminders, notify.router):
