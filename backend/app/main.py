...
from .routers import auth as auth_router, directions, mcp, mcp_oauth, mindmaps, notify, projects, shares, simple, tasks, telegram, tools
...
app = FastAPI(title="CIS Planner API", version="0.9.0", lifespan=lifespan)
...
for r in (directions.router, projects.router, shares.router, tasks.router, tools.router, simple.people, simple.delegations, simple.reminders, notify.router, mindmaps.router):
