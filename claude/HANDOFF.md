...
| **v0.9 Telegram-бот отвечает** | ✅ код + 17 тестов: `telegram_link.py`, `routers/telegram.py`, кнопка «Подключить Telegram» в профиле, `docs/TELEGRAM.md`. **Ждёт: `TELEGRAM_BOT_USERNAME=cisplannerbot` и `TELEGRAM_WEBHOOK_SECRET` в Railway, один запрос `setWebhook`, коммит** |
