...
_Обновлено: 2026-09-07, сессия 12 (Cowork). **Версия v0.11** — удобная версия для телефона: нижняя панель вкладок, шторка «Ещё» с левой панелью, доска одной колонкой со вкладками статусов, «⋯» на карточке меняет статус, карточка задачи на весь экран со статусом под названием; только фронт, миграций нет. v0.10 — внешние участники: раздел «Гости» (только админ), вход гостя по одноразовой ссылке на почту, мгновенный отзыв доступа. **Нужна миграция `d5e6f7a8b9c0`.** v0.9 — Telegram-бот показывает chat id, привязывает чат из профиля и ставит себе меню команд; тот же MCP-коннектор работает и в ChatGPT. v0.8 — починка по итогам адверсариального ревью (корзина, архив, «без направления», перенос проекта, права, OAuth, планировщик, безопасный confirm/автосейв). Сессия 8 — презентация для коллег (`claude/PRESENTATION.md`)._
