...
**Осталось** — владелец: коммит/пуш; завести бота и Azure-приложение, положить секреты в Railway, проверить `/api/notify/test`. Далее — напоминания по поручениям, шаг 6 (агенты).
